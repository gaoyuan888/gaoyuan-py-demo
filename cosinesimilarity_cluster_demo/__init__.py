...
if __name__ == '__main__':
    ...
    for index_ in range(samples_size):
        ...
        if cluster_tuple_list.__len__() == 0:
            idx_dep = (sentence_index, second_depart_name_list[index_], cluster_type,)
            type_list = [idx_dep]
            ...
            if dict_list[0][1] > 0.5:
                idx_dep = (sentence_index, second_depart_name_list[index_], dict_list[0][0],)
                cluster_tuple_list[dict_list[0][0]].append(idx_dep)
            else:
                cluster_type += 1
                idx_dep = (sentence_index, second_depart_name_list[index_], cluster_type,)
                type_list = [idx_dep]
